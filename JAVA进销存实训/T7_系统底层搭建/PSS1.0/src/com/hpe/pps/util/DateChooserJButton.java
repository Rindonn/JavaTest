...
//            int currentHour =c.get(Calendar.HOUR_OF_DAY);
            ...
            yearSpin.setPreferredSize(new Dimension(68,22)) ;/////////修改年宽度
            ...
            monthSpin.setPreferredSize(new Dimension(45,22)) ;//修改月宽度
        ...
        private JPanel createWeekAndDayPanal() {
            ...
            for(int i = 0; i < 6; i++)
                ...
                numberButton.setHorizontalAlignment(SwingConstants.CENTER);//设置文本居中
