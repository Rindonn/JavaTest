...
<body>
	<div class="page-header">
		<h3 align="center">添加二级分类</h3><br/>
		<p style="font-weight: 900; color: red">${msg}</p>
		<form class="form-horizontal"
			action="<c:url value='admincategoryservlet'/>" method="post"
			onsubmit="return checkForm()">
			<input type="hidden" name="method" value='addChildren'/>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<textarea name="desc" id="desc" rows="5" cols="50" class="form-control"></textarea>
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-7 col-sm-3">
					<button type="submit" class="btn btn-primary">添加二级分类</button>&nbsp;&nbsp;&nbsp;&nbsp;
