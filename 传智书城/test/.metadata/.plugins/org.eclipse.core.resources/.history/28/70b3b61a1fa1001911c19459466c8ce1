...
<body>
	<div class="page-header">
		<h3 align="center">添加图书</h3><br/>
		<p style="font-weight: 900; color: red;">${msg}</p>
		<form class="form-horizontal" action="<c:url value='/admin/AdminAddBookServlet'/>"
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" id="currPrice" name="currPrice"/>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" name="pageNum" id="pageNum"/>
				</div>
				<label for="wordNum" class="col-sm-1 control-label">字数：</label>
				<div class="col-sm-2">
					<input type="text" class="form-control" name="wordNum" id="wordNum"/>
				</div>
			</div>
			<div class="form-group">
				<label for="printtime" class="col-sm-2 control-label">印刷时间：</label>
				<div class="col-sm-2">
					<input type="text" class="form-control" name="printtime" id="printtime"/>
				</div>
				<label for="booksize" class="col-sm-1 control-label">开本：</label>
				<div class="col-sm-2">
					<input type="text" class="form-control" name="booksize" id="booksize"/>
				</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-8 col-sm-3">
					<button type="button" id="btn" class="btn btn-primary">新书上架</button>&nbsp;&nbsp;&nbsp;&nbsp;
